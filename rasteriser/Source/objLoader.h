...
void loadOBJ(
        ...
        printf("Opening file\n");
        std::ifstream file("Source/submarine.obj");
        printf("file open\n");
        ...
        for( unsigned int i=0; i<vertexIndices.size(); i++ ){
                triangles.push_back( Triangle(vec4(temp_vertices[vertexIndices[i][0] - 1]), vec4(temp_vertices[vertexIndices[i][1] - 1]), vec4(temp_vertices[vertexIndices[i][2] - 1]), yellow));
